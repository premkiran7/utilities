...
: '
This script has been taken from https://gist.github.com/irazasyed/a7b0a079e7727a4315b9
and some small modifications have been made. It can be used to add/remove a hostname to the
/etc/hosts file.

Usage (e.g):

sh manage_etc_hosts.sh remove twitter.com
sh manage_etc_hosts.sh add twitter.com
'
